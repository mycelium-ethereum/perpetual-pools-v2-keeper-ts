...
interface AutoClaimInterface extends ethers.utils.Interface {
  functions: {
    "checkClaim(tuple,uint256)": FunctionFragment;
    "checkUserClaim(address,address)": FunctionFragment;
    "claimRequests(address,address)": FunctionFragment;
...
export class AutoClaim extends BaseContract {
  ...
  claimRequests(
    ...
    [BigNumber, BigNumber] & { updateIntervalId: BigNumber; reward: BigNumber }
  >;
